        ...
        <div  className="flex justify-center h-[100vh] bg-slate-200 place-items-center">
            <div className=" sm:mx-auto sm:w-full sm:max-w-xl bg-white p-8 rounded-xl">
                ...
                <form  className="space-y-6" onSubmit={formik.handleSubmit}>
                    ...
                    <button type="submit"  className="flex w-full justify-center rounded-md bg-gray-500 px-3 py-2 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-gray-950 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Create Account</button>
                </form>
                <p  className="mt-2 text-center text-sm leading-9 tracking-tight text-gray-400">Already an account? <Link  className="text-gray-950 hover:text-gray-500" to="/">Login</Link> here to Log In.</p>
